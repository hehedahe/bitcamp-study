...
public class Client0310 {
  public static void main(String[] args) throws Exception {
    ...
    // 2) 연결할 서버의 주소를 준비한다.
    SocketAddress socketAddress = new InetSocketAddress("192.168.0.61", 8888); // SocketAddress는 추상클래스이므로 ?
    ...
    socket.connect(socketAddress, 10000); // 두 번째 값 => timeout : milliseconds
