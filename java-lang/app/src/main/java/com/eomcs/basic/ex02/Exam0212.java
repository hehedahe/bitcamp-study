...
public class Exam0212 {
  public static void main(String[] args) {
    ...
    System.out.println(Integer.toHexString(i)); // 16진수 문자열로 리턴해주는 메서드
    System.out.println(Integer.toOctalString(i)); // 8진수 문자열로 리턴
    System.out.println(Integer.toBinaryString(i)); // 2진수 문자열로 리턴
  }
}
