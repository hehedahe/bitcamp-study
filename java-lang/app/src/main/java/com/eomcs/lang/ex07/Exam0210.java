...
//
// 1) 명령문 블록을 실행할 때, (메서드 입장에서) 값을 받지 않고 결과도 리턴하지 않는다.
// void 메서드명() {
//   문장1;
//   문장2;
// }
...
// }
//
// 4) 명령어 블록을 실행할 때, 작업에 필요한 값을 받는다. 그리고 작업 결과를 받는다.
...
public class Exam0210 {
  ...
  public static void main(String[] args) {
    ...
    // => 메서드 실행하기
    // => 메서드 호출하기
    //    e.g. 다음은 "hello"라는 이름을 가진 메서드 블록을 찾아가서 실행하라는 의미.
    hello();
    // ## 실행 과정
    // 1) hello() 메서드의 블록으로 간다.
    // 2) 메서드 바디를 실행한다.
    // 3) 다시 원래 위치(호출한 쪽)로 돌아온다.
    // 4) 다음 줄을 실행한다.
