...
public class Exam0620 {
  ...
  public static void main(String[] 변수명은상관없다) {
    ...
    // $ java -cp ./bin/main -Dname=홍길동 -Dkor=100 -Deng=100 -Dmath=90 com.eomcs.lang.ex07.Exam0620
    // 이름: 홍길동
    // 총점: 290
    // 평균: 96.9
    //
    ...
    if (name == null || s1 == null || s2 == null || s3 == null) {
      System.out.println(
          "실행 형식: java -cp bin/main -Dname=이름 -Dkor=국어점수 -Deng=영어점수 -Dmath=수학점수 com.eomcs.lang.ex07.Exam0620");
      return;
    }
