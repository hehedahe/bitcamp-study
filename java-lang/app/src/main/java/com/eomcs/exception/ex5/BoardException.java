...
public class BoardException extends RuntimeException {
  // RuntimeException 이 Serializable 인터페이스 규칙에 따라 만들어졌는데, 
  // SerialVersionUID 를 생성하지 않아 노란줄이 떴었다! 
  //
