...
public class Exam0220 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // => 인스턴스 필드를 생성한 후 직접 필드에 값을 저장한다. (setter메서드가 아니라)
    //    그래서 역직렬화를 통해 인스턴스를 만들 때에는 생성자가 호출되지 않는다.
    ...
    Member member = (Member) in.readObject(); // 형변환을 확실히 알려줘야 한다!
