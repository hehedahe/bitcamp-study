...
public class Exam0111 {
  public static void main(String[] args) throws Exception {
    ...
    System.out.println(Charset.isSupported("EUC-KR")); // EUC-KR 지원하면 true, 아니면 false 리턴

    // 1) 출력 스트림 객체를 생성할 때 문자 집합을 지정하면 
    //    UCS2 문자열을 해당 문자집합으로 인코딩 한다.
    Charset charset = Charset.forName("EUC-KR");
    FileWriter out = new FileWriter("temp/test2.txt", charset); // file.encoding과 상관없이 지정된 문자집합으로 인코딩 한다.
